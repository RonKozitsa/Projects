...
/***/ "./node_modules/raw-loader/index.js!./src/app/Cart/components/cart-page/cart-page.component.html":
/*!**********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/Cart/components/cart-page/cart-page.component.html ***!
  \**********************************************************************************************/
...
/* harmony import */ var _components_cart_page_cart_page_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/cart-page/cart-page.component */ "./src/app/Cart/components/cart-page/cart-page.component.ts");
...
var CartModule = /** @class */ (function () {
    ...
    CartModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_components_cart_page_cart_page_component__WEBPACK_IMPORTED_MODULE_5__["CartPageComponent"]],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _Shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"],
                _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModalModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([
                    { path: '', component: _components_cart_page_cart_page_component__WEBPACK_IMPORTED_MODULE_5__["CartPageComponent"] }
                ])
            ]
        })
    ], CartModule);
...
/***/ "./src/app/Cart/components/cart-page/cart-page.component.css":
/*!*******************************************************************!*\
  !*** ./src/app/Cart/components/cart-page/cart-page.component.css ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/Cart/components/cart-page/cart-page.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/Cart/components/cart-page/cart-page.component.ts ***!
  \******************************************************************/
...
var CartPageComponent = /** @class */ (function () {
    function CartPageComponent(cartService, modalService, http) {
        this.cartService = cartService;
        this.modalService = modalService;
        this.http = http;
        this.cartItems = [];
        this.askIfDeleteItemName = '';
        this.displayLoader = false;
    }
    CartPageComponent.prototype.ngOnInit = function () {
        this.http.post(src_app_Shared_enums__WEBPACK_IMPORTED_MODULE_4__["SERVER"].URL + "/setstatusbyid/cart", {}).subscribe();
        this.fetchCart();
    };
    CartPageComponent.prototype.removeItem = function (itemId) {
        var _this = this;
        this.cartService.deleteItem(itemId).subscribe(function (response) {
            if (response.status === src_app_Shared_enums__WEBPACK_IMPORTED_MODULE_4__["HTTP_STATUS"].OK) {
                console.log('item removed');
                _this.fetchCart();
            }
        });
    };
    CartPageComponent.prototype.clearCart = function () {
        var _this = this;
        this.openModal(this.deleteCartTemplate).then(function () {
            _this.cartService.clearCart().subscribe(function () { return _this.fetchCart(); });
        });
    };
    CartPageComponent.prototype.openModal = function (modalTemplateRef) {
        return this.modalService.open(modalTemplateRef, {
            size: 'sm',
            centered: true
        }).result;
    };
    CartPageComponent.prototype.askIfSeleteItem = function (item) {
        var _this = this;
        this.askIfDeleteItemName = item.name;
        this.openModal(this.askIfDeleteItemTemplate).then(function () { return _this.removeItem(item._id); }, function () { });
    };
    CartPageComponent.prototype.fetchCart = function () {
        var _this = this;
        this.displayLoader = true;
        this.cartService.getUserCart().subscribe(function (cart) {
            _this.cartItems = cart;
            _this.cartItems = _this.cartService.removeDuplicates(_this.cartItems);
            _this.displayLoader = false;
        });
    };
    Object.defineProperty(CartPageComponent.prototype, "cartHasItems", {
        get: function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('askIfDeleteItemTemplate', { static: true })
    ], CartPageComponent.prototype, "askIfDeleteItemTemplate", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('deleteCartTemplate', { static: true })
    ], CartPageComponent.prototype, "deleteCartTemplate", void 0);
    CartPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-cart-page',
            template: __webpack_require__(/*! raw-loader!./cart-page.component.html */ "./node_modules/raw-loader/index.js!./src/app/Cart/components/cart-page/cart-page.component.html"),
            styles: [__webpack_require__(/*! ./cart-page.component.css */ "./src/app/Cart/components/cart-page/cart-page.component.css")]
        })
    ], CartPageComponent);
