...
var CheckoutPageComponent = /** @class */ (function () {
    function CheckoutPageComponent(cartService, http) {
    ...
    CheckoutPageComponent.prototype.setInfo = function () {
        var _this = this;
        var totalPrice = 0;
        var totalItems = 0;
        this.cartItems.forEach(function (item) {
            if (item._id in _this.cartItemsObject) {
                _this.cartItemsObject[item._id].amount += 1;
            }
            else {
                _this.cartItemsObject[item._id] = {
                    name: item.name,
                    amount: 1,
                    price: item.price
                };
    ...
    CheckoutPageComponent.ctorParameters = function () { return [
...
var ThankYouComponent = /** @class */ (function () {
    function ThankYouComponent(router, cartService) {
        this.router = router;
        this.cartService = cartService;
    }
    ThankYouComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            _this.message = 'Thank you for your Purchase !<br>You will be redirected to the home page';
            setTimeout(function () {
                _this.router.navigate(['/home']);
                _this.cartService.clearCart().subscribe();
            }, 2500);
        }, 5000);
    };
