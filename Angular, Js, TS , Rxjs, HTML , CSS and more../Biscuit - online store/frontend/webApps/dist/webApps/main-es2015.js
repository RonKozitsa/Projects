...
let LoginComponent = class LoginComponent {
    ...
    onLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.authService.logIn(this.name, this.password, this.rememberMe);
...
let SignupComponent = class SignupComponent {
    ...
    onSignUp() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.authService.registerNewUser(this.username, this.firstName, this.lastName, this.email, this.password);
            yield this.authService.logIn(this.username, this.password, false);
            this.router.navigate(['/home']);
        });
    }
};
...
let HomePageComponent = class HomePageComponent {
    constructor(backendCommunicatorService, http) {
    ...
    setItems() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.items = (yield this.backendCommunicatorService.getItemsBySearch(this.textualSearch));
        });
    }
};
...
let ItemComponent = class ItemComponent {
    ...
    getAmountInCart() {
        this.cartService.getUserCart().subscribe(cartItems => {
            this.amountInCart = 0;
            cartItems.forEach(item => this.amountInCart = item._id === this._id ? this.amountInCart + 1 : this.amountInCart);
        });
        ;
    }
};
...
let ShortenTextPipe = class ShortenTextPipe {
...
let AuthService = class AuthService {
    ...
    registerNewUser(userName, firstName, lastname, email, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const body = {
                ID: userName,
                Password: password,
            ...
            yield this.http.post(`${_enums__WEBPACK_IMPORTED_MODULE_4__["SERVER"].URL}/register`, body, { observe: 'response' }).toPromise().then(response => {
    ...
    logIn(userId, password, rememberMe) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.http.post(`${_enums__WEBPACK_IMPORTED_MODULE_4__["SERVER"].URL}/login`, body, { observe: 'response', withCredentials: true }).toPromise().then(response => {
                console.log(response);
                if (response.status === _enums__WEBPACK_IMPORTED_MODULE_4__["HTTP_STATUS"].OK) {
...
let BackendCommunicatorService = class BackendCommunicatorService {
    constructor(http) {
        this.http = http;
    }
    getItemsBySearch(searchText) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return (yield this.http.get(`${_enums__WEBPACK_IMPORTED_MODULE_3__["SERVER"].URL}/store/search/${searchText}`).toPromise());
        });
    }
    getAllUsers() {
...
BackendCommunicatorService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
const routes = [
    ...
    { path: 'cart', canActivate: [_Shared_Services_guards_auth_guard_service__WEBPACK_IMPORTED_MODULE_6__["AuthGuardService"]], loadChildren: () => __webpack_require__.e(/*! import() | Cart-cart-module */ "Cart-cart-module").then(__webpack_require__.bind(null, /*! ./Cart/cart.module */ "./src/app/Cart/cart.module.ts")).then(m => m.CartModule) },
    { path: 'checkout', canActivate: [_Shared_Services_guards_auth_guard_service__WEBPACK_IMPORTED_MODULE_6__["AuthGuardService"]], loadChildren: () => __webpack_require__.e(/*! import() | Checkout-checkout-module */ "Checkout-checkout-module").then(__webpack_require__.bind(null, /*! ./Checkout/checkout.module */ "./src/app/Checkout/checkout.module.ts")).then(m => m.CheckoutModule) },
    { path: 'admin', canActivate: [_Shared_Services_guards_admin_guard_service__WEBPACK_IMPORTED_MODULE_8__["AdminGuardService"]], loadChildren: () => __webpack_require__.e(/*! import() | Admin-screen-admin-module-module */ "Admin-screen-admin-module-module").then(__webpack_require__.bind(null, /*! ./Admin-screen/admin-module.module */ "./src/app/Admin-screen/admin-module.module.ts")).then(m => m.AdminModuleModule) },
